        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center" style={{ gap: 12, minWidth: 0 }}>
            {[
              ...
              <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.label} style={{ color: '#64748b', display: 'inline-flex', flexShrink: 0 }}>
                {s.label === 'Email' ? (
            ...
            <span className="hidden md:inline text-sm font-semibold tracking-wide text-white" style={{ marginLeft: 4 }}>The Experiment Playbook</span>
          </div>
